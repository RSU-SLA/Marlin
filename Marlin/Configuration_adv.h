...
#define HOMING_BUMP_DIVISOR { 2, 2, 4, 2, 2, 5, 5 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
#define DEFAULT_MINSEGMENTTIME        10   // (µs) Set with M205 B.
...
#define MINIMUM_PLANNER_SPEED 200 // (mm/s)
